...
export default function RecruiterDashboard() {
  ...
  const [recentApps, setRecentApps] = useState<Array<{ id: string; stage: string; appliedAt: string; job: { title: string }; candidate: { user: { name: string } } }>>([]);
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader><h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Recent Referred Applications</h2></CardHeader>
        <CardBody>
          {recentApps.length === 0 ? (
