            ...
            <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
              {recruiters.length === 0 ? (
                ...
                <tr key={r.id} className="hover:bg-gray-50 dark:hover:bg-gray-900/50">
                  ...
                  <td className="px-4 py-3"><Badge variant={r.totalReferrals > 0 && r.totalHires > 0 ? 'success' : 'default'}>{r.totalReferrals > 0 ? Math.round((r.totalHires / r.totalReferrals) * 100) : 0}%</Badge></td>
                </tr>
              ))}
            </tbody>
          </table>
